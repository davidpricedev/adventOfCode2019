...
class Day5Test : FreeSpec(
    {
        "Part1" - {
            "amp series examples" {
                ...
                ) { programRaw, settings, expected ->
                    val program = inputStringToList(programRaw)
                    runAmpSeries(program, settings) shouldBe expected
                }
            }
            "optimization examples" {
                forall(
                    row("3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0", Pair(listOf(4, 3, 2, 1, 0), 43210)),
                    row(
                        "3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0",
