...
/*
Notes:
* change up/down to y and left/right to plot all the points each line goes through on a normal cartesian coord system
* treat 0,0 as the core/starting point
* "join" the two sets of points to get all the intersections
* calculate manhattan distance (i.e. add x + y) and sort by result to find the nearest intersection to the core
 */
